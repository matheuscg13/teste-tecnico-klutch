...
class SolicitationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Solicitations
        fields = ['client', 'contract', 'interest_per_installment', 'number_of_installments', 'installment_value', 'total_value', 'comission', 'card_number', 'card_cvc', 'card_validity', 'desired_value', 'table']
